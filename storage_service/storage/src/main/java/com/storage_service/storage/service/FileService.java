...
public class FileService {
  ...
  public File uploadFile(MultipartFile file, boolean visibility, String version, String owner)
      throws IOException {
  ...
  private String getFileExtension(MultipartFile file) {
    ...
    return fileName != null && fileName.contains(".") ? fileName.substring(
        fileName.lastIndexOf(".") + 1) : "";
  }

  public String uploadFiles(List<MultipartFile> files, boolean visibility, String version,
  ...
  public byte[] processImage(Resource resource, Optional<Integer> width, Optional<Integer> height,
      Optional<Double> ratio) throws IOException {
  ...
  public File updateFile(String fileId, MultipartFile file, boolean visibility, String version)
      throws IOException {
