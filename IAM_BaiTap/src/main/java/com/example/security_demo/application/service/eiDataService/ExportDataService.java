...
import com.example.security_demo.infrastructure.persistance.repository.JpaUserProfileRepository;
import com.example.security_demo.infrastructure.persistance.repository.custom.UserProfileImpl;
...
public class ExportDataService {
  ...
  public ByteArrayInputStream exportUserData(UserProfileSearchRequest request) throws IOException {
    ...
    String[] headers = {"STT", "Username", "Full Name", "Birth Date", "Street", "District",
        "Province", "Experience"};
  ...
  public Object exportDataToStorage(UserProfileSearchRequest request) throws IOException {
    ...
    MultipartFile multipartFile = FileUtils.convertToMultipartFile(byteArrayInputStream,
        "user_data.xlsx");
