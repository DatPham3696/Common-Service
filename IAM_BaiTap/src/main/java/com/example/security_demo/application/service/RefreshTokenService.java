...
import com.example.security_demo.infrastructure.persistance.repository.JpaRefreshTokenRepository;
...
public class RefreshTokenService {
  ...
  public RefreshTokenEntity createRefreshToken(String userId, String accessTokenId,
      Date accessTokenExp) {
    RefreshTokenEntity refreshToken = new RefreshTokenEntity();
    refreshToken.setUserId(userId);
    refreshToken.setExpiryDate(new Date(System.currentTimeMillis() + refreshTokenDuration));
    refreshToken.setRefreshToken(
        jwtTokenUtils.generaRefreshToken(userRepository.findById(userId).get()));
