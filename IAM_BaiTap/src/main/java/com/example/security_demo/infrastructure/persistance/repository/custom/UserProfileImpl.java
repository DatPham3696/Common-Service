package com.example.security_demo.infrastructure.persistance.repository.custom;
...
import com.example.security_demo.infrastructure.persistance.repository.JpaUserProfileRepositoryCustom;
...
public class UserProfileImpl implements JpaUserProfileRepositoryCustom {
  ...
  public List<UserProfile> searchUser(UserProfileSearchRequest request) {
    ...
    String sql =
        "select e from UserProfile e " + createWhereQuery(request, values) + createOrderQuery(
            request.getSort());
