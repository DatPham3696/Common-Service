...
import com.example.security_demo.infrastructure.persistance.repository.JpaUserRepositoryCustom;
...
public class UserCustomRepositoryImpl implements JpaUserRepositoryCustom {
  ...
  public List<UserEntity> searchUser(UserSearchRequest request) {
    ...
    String sql = "select e from User e " + createWhereQuery(request, values) + createOrderQuery(
        request.getSort());
