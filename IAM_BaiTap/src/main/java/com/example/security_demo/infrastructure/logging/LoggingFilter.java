package com.example.security_demo.infrastructure.logging;
...
public class LoggingFilter implements Filter {
  ...
  public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
    ...
    ContentCachingRequestWrapper cachingRequestWrapper = new ContentCachingRequestWrapper(
        httpServletRequest);
    ...
    if (requestBody.toLowerCase().contains("password")) {
      requestBody = requestBody.replaceAll("(?i)\"passWord\"\\s*:\\s*\"[^\"]*\"",
          "\"passWord\":\"******\"");
    }
